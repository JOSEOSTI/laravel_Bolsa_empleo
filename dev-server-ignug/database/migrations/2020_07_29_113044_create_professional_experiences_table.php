...
class CreateProfessionalExperiencesTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection('pgsql-bolsa-empleo')->create('professional_experiences', function (Blueprint $table) {
            $table->increments('id');          
    ...
    {
        Schema::connection('pgsql-bolsa-empleo')->dropIfExists('professional_experiences');
    }
}
