...
class ProfessionalController extends Controller
{
  ...
  public  function getProfessionalExperiences(Request $request)
    {
        try {
            $professional = Professional::where('user_id', $request->user_id)->first();
            if ($professional) {
   ...
   public function getProfessionalReferences(Request $request)
    {
        try {
            $professional = Professional::where('user_id', $request->user_id)->first();
            if ($professional) {
  ...
  public  function filterOffers(Request $request)
   ...
   public function getAppliedCompanies(Request $request)
    {
        try {
            $professional = Professional::where('user_id', $request->user_id)->first();
            if ($professional) {
...
//                    ->orWhere('offer_professional.state', 'FINISHED')
   ...
   public function filterPostulants(Request $request)
    {
        $data = $request->json()->all();
   ...
   public function filterPostulantsFields(Request $request)
    {
        $postulants = Professional::
        join('academic_formations', 'academic_formations.professional_id', '=', 'professionals.id')
            ->where('professionals.about_me', '<>', '')
  ...
  public  function getAppliedOffers(Request $request)
    {
        try {
            $professional = Professional::where('user_id', $request->user_id)->first();
            if ($professional) {
...
//            ->paginate($request->limit);
  ...
  public  function getAllProfessionals()
   ...
   public function validateAppliedPostulant(Request $request)
    {
        try {
