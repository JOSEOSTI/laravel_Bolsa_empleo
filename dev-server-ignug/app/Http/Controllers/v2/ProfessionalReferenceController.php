...
class ProfessionalReferenceController extends Controller
{
  public  function getProfessionalReferences(Request $request)
   ...
   public function showProfessionalReference($id)
    {
        try {
   ...
   public function createProfessionalReference(Request $request)
    {
        try {
   ...
   public function updateProfessionalReference(Request $request)
    {
        try {
            $data = $request->json()->all();
            $dataProfessionalReference = $data['professionalReference'];
  ...
  public  function deleteProfessionalReference(Request $request)
    {
        try {
