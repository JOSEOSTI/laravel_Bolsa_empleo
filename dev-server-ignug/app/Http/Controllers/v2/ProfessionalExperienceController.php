...
class ProfessionalExperienceController extends Controller
{
   ...
   public function showProfessionalExperience($id)
    {
        try {
   ...
   public function createProfessionalExperience(Request $request)
    {
        try {
   ...
   public function updateProfessionalExperience(Request $request)
    {
        try {
            $data = $request->json()->all();
            $dataProfessionalExperiences = $data['professionalExperience'];
   ...
   public function deleteProfessionalExperience(Request $request)
    {
        try {
